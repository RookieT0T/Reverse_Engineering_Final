...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_3, c_5, c_10, c_14, c_8, c_7, c_9, c_11, c_1, c_11, c_15, c_0, c_5, c_8, c_9, c_7, c_5, c_12, c_9, c_1, c_11, c_14, c_15, c_10, c_7, c_4, c_2, c_8, c_12, c_6, c_6, c_4, c_10, c_0, c_4, c_0, c_9, c_9, c_11, c_12, c_9, c_13, c_12, c_6
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[524289]), [in43]"v"((uint64_t *)&arr[458753]), [in45]"v"((uint64_t *)&arr[589825]), [in47]"v"((uint64_t *)&arr[720897]), [in49]"v"((uint64_t *)&arr[65537]), [in51]"v"((uint64_t *)&arr[720898]), [in53]"v"((uint64_t *)&arr[983041]), [in55]"v"((uint64_t *)&arr[1]), [in57]"v"((uint64_t *)&arr[327682]), [in59]"v"((uint64_t *)&arr[524290]), [in61]"v"((uint64_t *)&arr[589826]), [in63]"v"((uint64_t *)&arr[458754]), [in65]"v"((uint64_t *)&arr[327683]), [in67]"v"((uint64_t *)&arr[786433]), [in69]"v"((uint64_t *)&arr[589827]), [in71]"v"((uint64_t *)&arr[65538]), [in73]"v"((uint64_t *)&arr[720899]), [in75]"v"((uint64_t *)&arr[917506]), [in77]"v"((uint64_t *)&arr[983042]), [in79]"v"((uint64_t *)&arr[655362])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[458755]), [in83]"v"((uint64_t *)&arr[262145]), [in85]"v"((uint64_t *)&arr[131073]), [in87]"v"((uint64_t *)&arr[524291]), [in89]"v"((uint64_t *)&arr[786434]), [in91]"v"((uint64_t *)&arr[393217]), [in93]"v"((uint64_t *)&arr[393218]), [in95]"v"((uint64_t *)&arr[262146]), [in97]"v"((uint64_t *)&arr[655363]), [in99]"v"((uint64_t *)&arr[2]), [in101]"v"((uint64_t *)&arr[262147]), [in103]"v"((uint64_t *)&arr[3]), [in105]"v"((uint64_t *)&arr[589828]), [in107]"v"((uint64_t *)&arr[589829]), [in109]"v"((uint64_t *)&arr[720900]), [in111]"v"((uint64_t *)&arr[786435]), [in113]"v"((uint64_t *)&arr[589830]), [in115]"v"((uint64_t *)&arr[851969]), [in117]"v"((uint64_t *)&arr[786436]), [in119]"v"((uint64_t *)&arr[393219])
        : "memory");
}
