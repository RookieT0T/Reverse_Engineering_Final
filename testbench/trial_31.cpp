...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_5, c_11, c_8, c_15, c_12, c_15, c_2, c_3, c_0, c_9, c_7, c_7, c_7, c_4, c_11, c_5, c_12, c_15, c_9, c_4, c_2, c_5, c_0, c_7, c_14, c_8, c_10, c_7, c_3, c_4, c_5, c_8, c_2, c_12, c_10, c_12, c_14, c_0, c_10, c_11, c_13, c_8, c_10, c_1
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[786433]), [in43]"v"((uint64_t *)&arr[983042]), [in45]"v"((uint64_t *)&arr[131073]), [in47]"v"((uint64_t *)&arr[196609]), [in49]"v"((uint64_t *)&arr[1]), [in51]"v"((uint64_t *)&arr[589825]), [in53]"v"((uint64_t *)&arr[458753]), [in55]"v"((uint64_t *)&arr[458754]), [in57]"v"((uint64_t *)&arr[458755]), [in59]"v"((uint64_t *)&arr[262145]), [in61]"v"((uint64_t *)&arr[720898]), [in63]"v"((uint64_t *)&arr[327682]), [in65]"v"((uint64_t *)&arr[786434]), [in67]"v"((uint64_t *)&arr[983043]), [in69]"v"((uint64_t *)&arr[589826]), [in71]"v"((uint64_t *)&arr[262146]), [in73]"v"((uint64_t *)&arr[131074]), [in75]"v"((uint64_t *)&arr[327683]), [in77]"v"((uint64_t *)&arr[2]), [in79]"v"((uint64_t *)&arr[458756])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[917505]), [in83]"v"((uint64_t *)&arr[524290]), [in85]"v"((uint64_t *)&arr[655361]), [in87]"v"((uint64_t *)&arr[458757]), [in89]"v"((uint64_t *)&arr[196610]), [in91]"v"((uint64_t *)&arr[262147]), [in93]"v"((uint64_t *)&arr[327684]), [in95]"v"((uint64_t *)&arr[524291]), [in97]"v"((uint64_t *)&arr[131075]), [in99]"v"((uint64_t *)&arr[786435]), [in101]"v"((uint64_t *)&arr[655362]), [in103]"v"((uint64_t *)&arr[786436]), [in105]"v"((uint64_t *)&arr[917506]), [in107]"v"((uint64_t *)&arr[3]), [in109]"v"((uint64_t *)&arr[655363]), [in111]"v"((uint64_t *)&arr[720899]), [in113]"v"((uint64_t *)&arr[851969]), [in115]"v"((uint64_t *)&arr[524292]), [in117]"v"((uint64_t *)&arr[655364]), [in119]"v"((uint64_t *)&arr[65537])
        : "memory");
}
