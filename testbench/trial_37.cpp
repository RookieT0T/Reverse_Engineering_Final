...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_5, c_14, c_8, c_10, c_11, c_5, c_15, c_5, c_4, c_2, c_1, c_15, c_4, c_15, c_12, c_7, c_5, c_13, c_8, c_8, c_3, c_1, c_7, c_9, c_14, c_13, c_11, c_12, c_1, c_4, c_10, c_11, c_8, c_11, c_4, c_12, c_6, c_12, c_0, c_11, c_11, c_15, c_5, c_1
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[720897]), [in43]"v"((uint64_t *)&arr[327682]), [in45]"v"((uint64_t *)&arr[983041]), [in47]"v"((uint64_t *)&arr[327683]), [in49]"v"((uint64_t *)&arr[262145]), [in51]"v"((uint64_t *)&arr[131073]), [in53]"v"((uint64_t *)&arr[65537]), [in55]"v"((uint64_t *)&arr[983042]), [in57]"v"((uint64_t *)&arr[262146]), [in59]"v"((uint64_t *)&arr[983043]), [in61]"v"((uint64_t *)&arr[786433]), [in63]"v"((uint64_t *)&arr[458753]), [in65]"v"((uint64_t *)&arr[327684]), [in67]"v"((uint64_t *)&arr[851969]), [in69]"v"((uint64_t *)&arr[524290]), [in71]"v"((uint64_t *)&arr[524291]), [in73]"v"((uint64_t *)&arr[196609]), [in75]"v"((uint64_t *)&arr[65538]), [in77]"v"((uint64_t *)&arr[458754]), [in79]"v"((uint64_t *)&arr[589825])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[917506]), [in83]"v"((uint64_t *)&arr[851970]), [in85]"v"((uint64_t *)&arr[720898]), [in87]"v"((uint64_t *)&arr[786434]), [in89]"v"((uint64_t *)&arr[65539]), [in91]"v"((uint64_t *)&arr[262147]), [in93]"v"((uint64_t *)&arr[655362]), [in95]"v"((uint64_t *)&arr[720899]), [in97]"v"((uint64_t *)&arr[524292]), [in99]"v"((uint64_t *)&arr[720900]), [in101]"v"((uint64_t *)&arr[262148]), [in103]"v"((uint64_t *)&arr[786435]), [in105]"v"((uint64_t *)&arr[393217]), [in107]"v"((uint64_t *)&arr[786436]), [in109]"v"((uint64_t *)&arr[1]), [in111]"v"((uint64_t *)&arr[720901]), [in113]"v"((uint64_t *)&arr[720902]), [in115]"v"((uint64_t *)&arr[983044]), [in117]"v"((uint64_t *)&arr[327685]), [in119]"v"((uint64_t *)&arr[65540])
        : "memory");
}
