...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_3, c_16, c_0, c_14, c_16, c_17, c_5, c_3, c_18, c_7, c_19, c_20, c_21, c_7, c_17, c_22, c_23, c_24, c_25, c_3, c_17, c_26, c_27, c_19, c_5, c_28, c_24, c_29, c_30, c_6, c_31, c_31, c_32, c_33, c_25, c_34, c_35, c_22, c_36, c_37, c_14, c_10, c_28, c_27
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[1048577]), [in43]"v"((uint64_t *)&arr[1114112]), [in45]"v"((uint64_t *)&arr[327681]), [in47]"v"((uint64_t *)&arr[196610]), [in49]"v"((uint64_t *)&arr[1179648]), [in51]"v"((uint64_t *)&arr[458753]), [in53]"v"((uint64_t *)&arr[1245184]), [in55]"v"((uint64_t *)&arr[1310720]), [in57]"v"((uint64_t *)&arr[1376256]), [in59]"v"((uint64_t *)&arr[458754]), [in61]"v"((uint64_t *)&arr[1114113]), [in63]"v"((uint64_t *)&arr[1441792]), [in65]"v"((uint64_t *)&arr[1507328]), [in67]"v"((uint64_t *)&arr[1572864]), [in69]"v"((uint64_t *)&arr[1638400]), [in71]"v"((uint64_t *)&arr[196611]), [in73]"v"((uint64_t *)&arr[1114114]), [in75]"v"((uint64_t *)&arr[1703936]), [in77]"v"((uint64_t *)&arr[1769472]), [in79]"v"((uint64_t *)&arr[1245185])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[327682]), [in83]"v"((uint64_t *)&arr[1835008]), [in85]"v"((uint64_t *)&arr[1572865]), [in87]"v"((uint64_t *)&arr[1900544]), [in89]"v"((uint64_t *)&arr[1966080]), [in91]"v"((uint64_t *)&arr[393217]), [in93]"v"((uint64_t *)&arr[2031616]), [in95]"v"((uint64_t *)&arr[2031617]), [in97]"v"((uint64_t *)&arr[2097152]), [in99]"v"((uint64_t *)&arr[2162688]), [in101]"v"((uint64_t *)&arr[1638401]), [in103]"v"((uint64_t *)&arr[2228224]), [in105]"v"((uint64_t *)&arr[2293760]), [in107]"v"((uint64_t *)&arr[1441793]), [in109]"v"((uint64_t *)&arr[2359296]), [in111]"v"((uint64_t *)&arr[2424832]), [in113]"v"((uint64_t *)&arr[917506]), [in115]"v"((uint64_t *)&arr[655361]), [in117]"v"((uint64_t *)&arr[1835009]), [in119]"v"((uint64_t *)&arr[1769473])
        : "memory");
}
