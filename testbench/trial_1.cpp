...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_14, c_13, c_12, c_0, c_13, c_13, c_3, c_15, c_11, c_7, c_11, c_1, c_13, c_14, c_8, c_7, c_6, c_8, c_10, c_1, c_15, c_3, c_5, c_5, c_13, c_2, c_14, c_6, c_13, c_13, c_14, c_15, c_0, c_12, c_2, c_11, c_1, c_7, c_8, c_11, c_12, c_14, c_8, c_10
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[851970]), [in43]"v"((uint64_t *)&arr[851971]), [in45]"v"((uint64_t *)&arr[196609]), [in47]"v"((uint64_t *)&arr[983041]), [in49]"v"((uint64_t *)&arr[720897]), [in51]"v"((uint64_t *)&arr[458753]), [in53]"v"((uint64_t *)&arr[720898]), [in55]"v"((uint64_t *)&arr[65537]), [in57]"v"((uint64_t *)&arr[851972]), [in59]"v"((uint64_t *)&arr[917506]), [in61]"v"((uint64_t *)&arr[524289]), [in63]"v"((uint64_t *)&arr[458754]), [in65]"v"((uint64_t *)&arr[393217]), [in67]"v"((uint64_t *)&arr[524290]), [in69]"v"((uint64_t *)&arr[655361]), [in71]"v"((uint64_t *)&arr[65538]), [in73]"v"((uint64_t *)&arr[983042]), [in75]"v"((uint64_t *)&arr[196610]), [in77]"v"((uint64_t *)&arr[327681]), [in79]"v"((uint64_t *)&arr[327682])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[851973]), [in83]"v"((uint64_t *)&arr[131073]), [in85]"v"((uint64_t *)&arr[917507]), [in87]"v"((uint64_t *)&arr[393218]), [in89]"v"((uint64_t *)&arr[851974]), [in91]"v"((uint64_t *)&arr[851975]), [in93]"v"((uint64_t *)&arr[917508]), [in95]"v"((uint64_t *)&arr[983043]), [in97]"v"((uint64_t *)&arr[2]), [in99]"v"((uint64_t *)&arr[786434]), [in101]"v"((uint64_t *)&arr[131074]), [in103]"v"((uint64_t *)&arr[720899]), [in105]"v"((uint64_t *)&arr[65539]), [in107]"v"((uint64_t *)&arr[458755]), [in109]"v"((uint64_t *)&arr[524291]), [in111]"v"((uint64_t *)&arr[720900]), [in113]"v"((uint64_t *)&arr[786435]), [in115]"v"((uint64_t *)&arr[917509]), [in117]"v"((uint64_t *)&arr[524292]), [in119]"v"((uint64_t *)&arr[655362])
        : "memory");
}
