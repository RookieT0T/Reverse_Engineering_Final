...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_6, c_9, c_1, c_4, c_6, c_16, c_8, c_10, c_17, c_2, c_7, c_0, c_18, c_16, c_14, c_16, c_14, c_0, c_11, c_2, c_10, c_19, c_20, c_8, c_15, c_21, c_22, c_23, c_3, c_12, c_24, c_25, c_15, c_4, c_24, c_23, c_26, c_22, c_6, c_18, c_8, c_4, c_27, c_17
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[393218]), [in43]"v"((uint64_t *)&arr[1048576]), [in45]"v"((uint64_t *)&arr[524289]), [in47]"v"((uint64_t *)&arr[655361]), [in49]"v"((uint64_t *)&arr[1114112]), [in51]"v"((uint64_t *)&arr[131073]), [in53]"v"((uint64_t *)&arr[458753]), [in55]"v"((uint64_t *)&arr[1]), [in57]"v"((uint64_t *)&arr[1179648]), [in59]"v"((uint64_t *)&arr[1048577]), [in61]"v"((uint64_t *)&arr[917505]), [in63]"v"((uint64_t *)&arr[1048578]), [in65]"v"((uint64_t *)&arr[917506]), [in67]"v"((uint64_t *)&arr[2]), [in69]"v"((uint64_t *)&arr[720897]), [in71]"v"((uint64_t *)&arr[131074]), [in73]"v"((uint64_t *)&arr[655362]), [in75]"v"((uint64_t *)&arr[1245184]), [in77]"v"((uint64_t *)&arr[1310720]), [in79]"v"((uint64_t *)&arr[524290])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[983041]), [in83]"v"((uint64_t *)&arr[1376256]), [in85]"v"((uint64_t *)&arr[1441792]), [in87]"v"((uint64_t *)&arr[1507328]), [in89]"v"((uint64_t *)&arr[196609]), [in91]"v"((uint64_t *)&arr[786433]), [in93]"v"((uint64_t *)&arr[1572864]), [in95]"v"((uint64_t *)&arr[1638400]), [in97]"v"((uint64_t *)&arr[983042]), [in99]"v"((uint64_t *)&arr[262146]), [in101]"v"((uint64_t *)&arr[1572865]), [in103]"v"((uint64_t *)&arr[1507329]), [in105]"v"((uint64_t *)&arr[1703936]), [in107]"v"((uint64_t *)&arr[1441793]), [in109]"v"((uint64_t *)&arr[393219]), [in111]"v"((uint64_t *)&arr[1179649]), [in113]"v"((uint64_t *)&arr[524291]), [in115]"v"((uint64_t *)&arr[262147]), [in117]"v"((uint64_t *)&arr[1769472]), [in119]"v"((uint64_t *)&arr[1114113])
        : "memory");
}
