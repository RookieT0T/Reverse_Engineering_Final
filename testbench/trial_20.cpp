...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_8, c_3, c_6, c_16, c_17, c_18, c_5, c_6, c_10, c_2, c_19, c_9, c_20, c_14, c_21, c_9, c_21, c_22, c_13, c_15, c_3, c_23, c_9, c_17, c_24, c_25, c_4, c_22, c_13, c_22, c_7, c_26, c_10, c_10, c_27, c_28, c_2, c_29, c_30, c_31, c_12, c_5, c_32, c_33
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[1114112]), [in43]"v"((uint64_t *)&arr[1179648]), [in45]"v"((uint64_t *)&arr[327681]), [in47]"v"((uint64_t *)&arr[393218]), [in49]"v"((uint64_t *)&arr[655361]), [in51]"v"((uint64_t *)&arr[131073]), [in53]"v"((uint64_t *)&arr[1245184]), [in55]"v"((uint64_t *)&arr[589825]), [in57]"v"((uint64_t *)&arr[1310720]), [in59]"v"((uint64_t *)&arr[917505]), [in61]"v"((uint64_t *)&arr[1376256]), [in63]"v"((uint64_t *)&arr[589826]), [in65]"v"((uint64_t *)&arr[1376257]), [in67]"v"((uint64_t *)&arr[1441792]), [in69]"v"((uint64_t *)&arr[851969]), [in71]"v"((uint64_t *)&arr[983041]), [in73]"v"((uint64_t *)&arr[196610]), [in75]"v"((uint64_t *)&arr[1507328]), [in77]"v"((uint64_t *)&arr[589827]), [in79]"v"((uint64_t *)&arr[1114113])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[1572864]), [in83]"v"((uint64_t *)&arr[1638400]), [in85]"v"((uint64_t *)&arr[262145]), [in87]"v"((uint64_t *)&arr[1441793]), [in89]"v"((uint64_t *)&arr[851970]), [in91]"v"((uint64_t *)&arr[1441794]), [in93]"v"((uint64_t *)&arr[458753]), [in95]"v"((uint64_t *)&arr[1703936]), [in97]"v"((uint64_t *)&arr[655362]), [in99]"v"((uint64_t *)&arr[655363]), [in101]"v"((uint64_t *)&arr[1769472]), [in103]"v"((uint64_t *)&arr[1835008]), [in105]"v"((uint64_t *)&arr[131074]), [in107]"v"((uint64_t *)&arr[1900544]), [in109]"v"((uint64_t *)&arr[1966080]), [in111]"v"((uint64_t *)&arr[2031616]), [in113]"v"((uint64_t *)&arr[786433]), [in115]"v"((uint64_t *)&arr[327682]), [in117]"v"((uint64_t *)&arr[2097152]), [in119]"v"((uint64_t *)&arr[2162688])
        : "memory");
}
