...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_2, c_6, c_12, c_1, c_10, c_9, c_8, c_9, c_3, c_1, c_11, c_14, c_1, c_13, c_14, c_2, c_15, c_6, c_3, c_11, c_11, c_9, c_4, c_11, c_0, c_10, c_6, c_9, c_2, c_6, c_4, c_8, c_1, c_5, c_10, c_4, c_8, c_2, c_3, c_9, c_15, c_14, c_3, c_6
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[655361]), [in43]"v"((uint64_t *)&arr[589825]), [in45]"v"((uint64_t *)&arr[524289]), [in47]"v"((uint64_t *)&arr[589826]), [in49]"v"((uint64_t *)&arr[196609]), [in51]"v"((uint64_t *)&arr[65538]), [in53]"v"((uint64_t *)&arr[720897]), [in55]"v"((uint64_t *)&arr[917505]), [in57]"v"((uint64_t *)&arr[65539]), [in59]"v"((uint64_t *)&arr[851969]), [in61]"v"((uint64_t *)&arr[917506]), [in63]"v"((uint64_t *)&arr[131074]), [in65]"v"((uint64_t *)&arr[983041]), [in67]"v"((uint64_t *)&arr[393218]), [in69]"v"((uint64_t *)&arr[196610]), [in71]"v"((uint64_t *)&arr[720898]), [in73]"v"((uint64_t *)&arr[720899]), [in75]"v"((uint64_t *)&arr[589827]), [in77]"v"((uint64_t *)&arr[262145]), [in79]"v"((uint64_t *)&arr[720900])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[1]), [in83]"v"((uint64_t *)&arr[655362]), [in85]"v"((uint64_t *)&arr[393219]), [in87]"v"((uint64_t *)&arr[589828]), [in89]"v"((uint64_t *)&arr[131075]), [in91]"v"((uint64_t *)&arr[393220]), [in93]"v"((uint64_t *)&arr[262146]), [in95]"v"((uint64_t *)&arr[524290]), [in97]"v"((uint64_t *)&arr[65540]), [in99]"v"((uint64_t *)&arr[327681]), [in101]"v"((uint64_t *)&arr[655363]), [in103]"v"((uint64_t *)&arr[262147]), [in105]"v"((uint64_t *)&arr[524291]), [in107]"v"((uint64_t *)&arr[131076]), [in109]"v"((uint64_t *)&arr[196611]), [in111]"v"((uint64_t *)&arr[589829]), [in113]"v"((uint64_t *)&arr[983042]), [in115]"v"((uint64_t *)&arr[917507]), [in117]"v"((uint64_t *)&arr[196612]), [in119]"v"((uint64_t *)&arr[393221])
        : "memory");
}
