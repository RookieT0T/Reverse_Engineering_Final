...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_13, c_14, c_5, c_14, c_5, c_13, c_5, c_13, c_6, c_2, c_13, c_10, c_4, c_14, c_14, c_9, c_0, c_15, c_3, c_13, c_6, c_13, c_6, c_8, c_13, c_13, c_15, c_6, c_11, c_14, c_10, c_2, c_11, c_15, c_8, c_15, c_0, c_14, c_3, c_8, c_9, c_11, c_15, c_1
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[327682]), [in43]"v"((uint64_t *)&arr[851970]), [in45]"v"((uint64_t *)&arr[327683]), [in47]"v"((uint64_t *)&arr[851971]), [in49]"v"((uint64_t *)&arr[393217]), [in51]"v"((uint64_t *)&arr[131073]), [in53]"v"((uint64_t *)&arr[851972]), [in55]"v"((uint64_t *)&arr[655361]), [in57]"v"((uint64_t *)&arr[262145]), [in59]"v"((uint64_t *)&arr[917507]), [in61]"v"((uint64_t *)&arr[917508]), [in63]"v"((uint64_t *)&arr[589825]), [in65]"v"((uint64_t *)&arr[1]), [in67]"v"((uint64_t *)&arr[983041]), [in69]"v"((uint64_t *)&arr[196609]), [in71]"v"((uint64_t *)&arr[851973]), [in73]"v"((uint64_t *)&arr[393218]), [in75]"v"((uint64_t *)&arr[851974]), [in77]"v"((uint64_t *)&arr[393219]), [in79]"v"((uint64_t *)&arr[524289])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[851975]), [in83]"v"((uint64_t *)&arr[851976]), [in85]"v"((uint64_t *)&arr[983042]), [in87]"v"((uint64_t *)&arr[393220]), [in89]"v"((uint64_t *)&arr[720897]), [in91]"v"((uint64_t *)&arr[917509]), [in93]"v"((uint64_t *)&arr[655362]), [in95]"v"((uint64_t *)&arr[131074]), [in97]"v"((uint64_t *)&arr[720898]), [in99]"v"((uint64_t *)&arr[983043]), [in101]"v"((uint64_t *)&arr[524290]), [in103]"v"((uint64_t *)&arr[983044]), [in105]"v"((uint64_t *)&arr[2]), [in107]"v"((uint64_t *)&arr[917510]), [in109]"v"((uint64_t *)&arr[196610]), [in111]"v"((uint64_t *)&arr[524291]), [in113]"v"((uint64_t *)&arr[589826]), [in115]"v"((uint64_t *)&arr[720899]), [in117]"v"((uint64_t *)&arr[983045]), [in119]"v"((uint64_t *)&arr[65537])
        : "memory");
}
