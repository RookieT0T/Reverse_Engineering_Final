...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_14, c_7, c_5, c_6, c_11, c_13, c_11, c_1, c_8, c_15, c_8, c_1, c_9, c_4, c_0, c_14, c_5, c_11, c_10, c_4, c_8, c_0, c_8, c_8, c_4, c_2, c_5, c_4, c_0, c_1, c_13, c_10, c_7, c_9, c_3, c_8, c_3, c_7, c_11, c_11, c_14, c_8, c_12, c_13
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[720897]), [in43]"v"((uint64_t *)&arr[851969]), [in45]"v"((uint64_t *)&arr[720898]), [in47]"v"((uint64_t *)&arr[65537]), [in49]"v"((uint64_t *)&arr[524289]), [in51]"v"((uint64_t *)&arr[983041]), [in53]"v"((uint64_t *)&arr[524290]), [in55]"v"((uint64_t *)&arr[65538]), [in57]"v"((uint64_t *)&arr[589825]), [in59]"v"((uint64_t *)&arr[262145]), [in61]"v"((uint64_t *)&arr[1]), [in63]"v"((uint64_t *)&arr[917506]), [in65]"v"((uint64_t *)&arr[327682]), [in67]"v"((uint64_t *)&arr[720899]), [in69]"v"((uint64_t *)&arr[655361]), [in71]"v"((uint64_t *)&arr[262146]), [in73]"v"((uint64_t *)&arr[524291]), [in75]"v"((uint64_t *)&arr[2]), [in77]"v"((uint64_t *)&arr[524292]), [in79]"v"((uint64_t *)&arr[524293])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[262147]), [in83]"v"((uint64_t *)&arr[131073]), [in85]"v"((uint64_t *)&arr[327683]), [in87]"v"((uint64_t *)&arr[262148]), [in89]"v"((uint64_t *)&arr[3]), [in91]"v"((uint64_t *)&arr[65539]), [in93]"v"((uint64_t *)&arr[851970]), [in95]"v"((uint64_t *)&arr[655362]), [in97]"v"((uint64_t *)&arr[458754]), [in99]"v"((uint64_t *)&arr[589826]), [in101]"v"((uint64_t *)&arr[196609]), [in103]"v"((uint64_t *)&arr[524294]), [in105]"v"((uint64_t *)&arr[196610]), [in107]"v"((uint64_t *)&arr[458755]), [in109]"v"((uint64_t *)&arr[720900]), [in111]"v"((uint64_t *)&arr[720901]), [in113]"v"((uint64_t *)&arr[917507]), [in115]"v"((uint64_t *)&arr[524295]), [in117]"v"((uint64_t *)&arr[786433]), [in119]"v"((uint64_t *)&arr[851971])
        : "memory");
}
