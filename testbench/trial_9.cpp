...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_9, c_9, c_11, c_3, c_15, c_2, c_2, c_8, c_8, c_15, c_6, c_7, c_13, c_10, c_14, c_12, c_8, c_13, c_3, c_11, c_1, c_12, c_9, c_1, c_1, c_14, c_3, c_11, c_15, c_11, c_9, c_9, c_4, c_8, c_15, c_7, c_9, c_4, c_2, c_4, c_0, c_15, c_3, c_3
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[983041]), [in43]"v"((uint64_t *)&arr[131073]), [in45]"v"((uint64_t *)&arr[131074]), [in47]"v"((uint64_t *)&arr[524289]), [in49]"v"((uint64_t *)&arr[524290]), [in51]"v"((uint64_t *)&arr[983042]), [in53]"v"((uint64_t *)&arr[393217]), [in55]"v"((uint64_t *)&arr[458753]), [in57]"v"((uint64_t *)&arr[851969]), [in59]"v"((uint64_t *)&arr[655361]), [in61]"v"((uint64_t *)&arr[917505]), [in63]"v"((uint64_t *)&arr[786433]), [in65]"v"((uint64_t *)&arr[524291]), [in67]"v"((uint64_t *)&arr[851970]), [in69]"v"((uint64_t *)&arr[196610]), [in71]"v"((uint64_t *)&arr[720898]), [in73]"v"((uint64_t *)&arr[65537]), [in75]"v"((uint64_t *)&arr[786434]), [in77]"v"((uint64_t *)&arr[589827]), [in79]"v"((uint64_t *)&arr[65538])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[65539]), [in83]"v"((uint64_t *)&arr[917506]), [in85]"v"((uint64_t *)&arr[196611]), [in87]"v"((uint64_t *)&arr[720899]), [in89]"v"((uint64_t *)&arr[983043]), [in91]"v"((uint64_t *)&arr[720900]), [in93]"v"((uint64_t *)&arr[589828]), [in95]"v"((uint64_t *)&arr[589829]), [in97]"v"((uint64_t *)&arr[262145]), [in99]"v"((uint64_t *)&arr[524292]), [in101]"v"((uint64_t *)&arr[983044]), [in103]"v"((uint64_t *)&arr[458754]), [in105]"v"((uint64_t *)&arr[589830]), [in107]"v"((uint64_t *)&arr[262146]), [in109]"v"((uint64_t *)&arr[131075]), [in111]"v"((uint64_t *)&arr[262147]), [in113]"v"((uint64_t *)&arr[1]), [in115]"v"((uint64_t *)&arr[983045]), [in117]"v"((uint64_t *)&arr[196612]), [in119]"v"((uint64_t *)&arr[196613])
        : "memory");
}
