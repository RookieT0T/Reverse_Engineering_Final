...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_10, c_8, c_8, c_9, c_6, c_14, c_3, c_12, c_13, c_14, c_5, c_0, c_8, c_7, c_5, c_1, c_8, c_3, c_11, c_5, c_7, c_13, c_5, c_0, c_0, c_14, c_9, c_9, c_14, c_13, c_9, c_2, c_2, c_1, c_6, c_2, c_9, c_14, c_7, c_2, c_12, c_10, c_14, c_0
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[393217]), [in43]"v"((uint64_t *)&arr[917505]), [in45]"v"((uint64_t *)&arr[196609]), [in47]"v"((uint64_t *)&arr[786433]), [in49]"v"((uint64_t *)&arr[851969]), [in51]"v"((uint64_t *)&arr[917506]), [in53]"v"((uint64_t *)&arr[327681]), [in55]"v"((uint64_t *)&arr[1]), [in57]"v"((uint64_t *)&arr[524291]), [in59]"v"((uint64_t *)&arr[458753]), [in61]"v"((uint64_t *)&arr[327682]), [in63]"v"((uint64_t *)&arr[65537]), [in65]"v"((uint64_t *)&arr[524292]), [in67]"v"((uint64_t *)&arr[196610]), [in69]"v"((uint64_t *)&arr[720897]), [in71]"v"((uint64_t *)&arr[327683]), [in73]"v"((uint64_t *)&arr[458754]), [in75]"v"((uint64_t *)&arr[851970]), [in77]"v"((uint64_t *)&arr[327684]), [in79]"v"((uint64_t *)&arr[2])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[3]), [in83]"v"((uint64_t *)&arr[917507]), [in85]"v"((uint64_t *)&arr[589826]), [in87]"v"((uint64_t *)&arr[589827]), [in89]"v"((uint64_t *)&arr[917508]), [in91]"v"((uint64_t *)&arr[851971]), [in93]"v"((uint64_t *)&arr[589828]), [in95]"v"((uint64_t *)&arr[131073]), [in97]"v"((uint64_t *)&arr[131074]), [in99]"v"((uint64_t *)&arr[65538]), [in101]"v"((uint64_t *)&arr[393218]), [in103]"v"((uint64_t *)&arr[131075]), [in105]"v"((uint64_t *)&arr[589829]), [in107]"v"((uint64_t *)&arr[917509]), [in109]"v"((uint64_t *)&arr[458755]), [in111]"v"((uint64_t *)&arr[131076]), [in113]"v"((uint64_t *)&arr[786434]), [in115]"v"((uint64_t *)&arr[655362]), [in117]"v"((uint64_t *)&arr[917510]), [in119]"v"((uint64_t *)&arr[4])
        : "memory");
}
