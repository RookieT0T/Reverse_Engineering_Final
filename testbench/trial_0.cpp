...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_7, c_13, c_12, c_15, c_5, c_13, c_10, c_3, c_10, c_4, c_13, c_3, c_4, c_12, c_9, c_10, c_6, c_8, c_6, c_3, c_11, c_11, c_0, c_10, c_0, c_11, c_12, c_12, c_2, c_8, c_0, c_9, c_8, c_0, c_4, c_10, c_12, c_13, c_14, c_1, c_7, c_4, c_14, c_10
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[327681]), [in43]"v"((uint64_t *)&arr[851970]), [in45]"v"((uint64_t *)&arr[655361]), [in47]"v"((uint64_t *)&arr[196609]), [in49]"v"((uint64_t *)&arr[655362]), [in51]"v"((uint64_t *)&arr[262145]), [in53]"v"((uint64_t *)&arr[851971]), [in55]"v"((uint64_t *)&arr[196610]), [in57]"v"((uint64_t *)&arr[262146]), [in59]"v"((uint64_t *)&arr[786434]), [in61]"v"((uint64_t *)&arr[589825]), [in63]"v"((uint64_t *)&arr[655363]), [in65]"v"((uint64_t *)&arr[393217]), [in67]"v"((uint64_t *)&arr[524289]), [in69]"v"((uint64_t *)&arr[393218]), [in71]"v"((uint64_t *)&arr[196611]), [in73]"v"((uint64_t *)&arr[720897]), [in75]"v"((uint64_t *)&arr[720898]), [in77]"v"((uint64_t *)&arr[1]), [in79]"v"((uint64_t *)&arr[655364])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[2]), [in83]"v"((uint64_t *)&arr[720899]), [in85]"v"((uint64_t *)&arr[786435]), [in87]"v"((uint64_t *)&arr[786436]), [in89]"v"((uint64_t *)&arr[131073]), [in91]"v"((uint64_t *)&arr[524290]), [in93]"v"((uint64_t *)&arr[3]), [in95]"v"((uint64_t *)&arr[589826]), [in97]"v"((uint64_t *)&arr[524291]), [in99]"v"((uint64_t *)&arr[4]), [in101]"v"((uint64_t *)&arr[262147]), [in103]"v"((uint64_t *)&arr[655365]), [in105]"v"((uint64_t *)&arr[786437]), [in107]"v"((uint64_t *)&arr[851972]), [in109]"v"((uint64_t *)&arr[917505]), [in111]"v"((uint64_t *)&arr[65537]), [in113]"v"((uint64_t *)&arr[458754]), [in115]"v"((uint64_t *)&arr[262148]), [in117]"v"((uint64_t *)&arr[917506]), [in119]"v"((uint64_t *)&arr[655366])
        : "memory");
}
