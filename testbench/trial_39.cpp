...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_12, c_7, c_5, c_6, c_12, c_11, c_10, c_3, c_0, c_6, c_11, c_12, c_10, c_2, c_9, c_8, c_1, c_7, c_2, c_15, c_6, c_2, c_14, c_11, c_8, c_2, c_8, c_9, c_5, c_15, c_9, c_12, c_13, c_9, c_13, c_7, c_10, c_15, c_12, c_13, c_11, c_10, c_10, c_10
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[786434]), [in43]"v"((uint64_t *)&arr[720897]), [in45]"v"((uint64_t *)&arr[655361]), [in47]"v"((uint64_t *)&arr[196609]), [in49]"v"((uint64_t *)&arr[1]), [in51]"v"((uint64_t *)&arr[393218]), [in53]"v"((uint64_t *)&arr[720898]), [in55]"v"((uint64_t *)&arr[786435]), [in57]"v"((uint64_t *)&arr[655362]), [in59]"v"((uint64_t *)&arr[131073]), [in61]"v"((uint64_t *)&arr[589825]), [in63]"v"((uint64_t *)&arr[524289]), [in65]"v"((uint64_t *)&arr[65537]), [in67]"v"((uint64_t *)&arr[458754]), [in69]"v"((uint64_t *)&arr[131074]), [in71]"v"((uint64_t *)&arr[983041]), [in73]"v"((uint64_t *)&arr[393219]), [in75]"v"((uint64_t *)&arr[131075]), [in77]"v"((uint64_t *)&arr[917505]), [in79]"v"((uint64_t *)&arr[720899])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[524290]), [in83]"v"((uint64_t *)&arr[131076]), [in85]"v"((uint64_t *)&arr[524291]), [in87]"v"((uint64_t *)&arr[589826]), [in89]"v"((uint64_t *)&arr[327682]), [in91]"v"((uint64_t *)&arr[983042]), [in93]"v"((uint64_t *)&arr[589827]), [in95]"v"((uint64_t *)&arr[786436]), [in97]"v"((uint64_t *)&arr[851969]), [in99]"v"((uint64_t *)&arr[589828]), [in101]"v"((uint64_t *)&arr[851970]), [in103]"v"((uint64_t *)&arr[458755]), [in105]"v"((uint64_t *)&arr[655363]), [in107]"v"((uint64_t *)&arr[983043]), [in109]"v"((uint64_t *)&arr[786437]), [in111]"v"((uint64_t *)&arr[851971]), [in113]"v"((uint64_t *)&arr[720900]), [in115]"v"((uint64_t *)&arr[655364]), [in117]"v"((uint64_t *)&arr[655365]), [in119]"v"((uint64_t *)&arr[655366])
        : "memory");
}
