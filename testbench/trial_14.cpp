...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_7, c_11, c_6, c_6, c_10, c_0, c_5, c_6, c_5, c_13, c_7, c_6, c_6, c_11, c_14, c_5, c_12, c_4, c_5, c_9, c_11, c_5, c_7, c_3, c_15, c_10, c_15, c_15, c_10, c_7, c_2, c_12, c_1, c_2, c_12, c_2, c_1, c_10, c_7, c_7, c_11, c_1, c_10, c_3
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[655361]), [in43]"v"((uint64_t *)&arr[1]), [in45]"v"((uint64_t *)&arr[327681]), [in47]"v"((uint64_t *)&arr[393219]), [in49]"v"((uint64_t *)&arr[327682]), [in51]"v"((uint64_t *)&arr[851969]), [in53]"v"((uint64_t *)&arr[458754]), [in55]"v"((uint64_t *)&arr[393220]), [in57]"v"((uint64_t *)&arr[393221]), [in59]"v"((uint64_t *)&arr[720898]), [in61]"v"((uint64_t *)&arr[917505]), [in63]"v"((uint64_t *)&arr[327683]), [in65]"v"((uint64_t *)&arr[786433]), [in67]"v"((uint64_t *)&arr[262145]), [in69]"v"((uint64_t *)&arr[327684]), [in71]"v"((uint64_t *)&arr[589825]), [in73]"v"((uint64_t *)&arr[720899]), [in75]"v"((uint64_t *)&arr[327685]), [in77]"v"((uint64_t *)&arr[458755]), [in79]"v"((uint64_t *)&arr[196609])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[983041]), [in83]"v"((uint64_t *)&arr[655362]), [in85]"v"((uint64_t *)&arr[983042]), [in87]"v"((uint64_t *)&arr[983043]), [in89]"v"((uint64_t *)&arr[655363]), [in91]"v"((uint64_t *)&arr[458756]), [in93]"v"((uint64_t *)&arr[131073]), [in95]"v"((uint64_t *)&arr[786434]), [in97]"v"((uint64_t *)&arr[65537]), [in99]"v"((uint64_t *)&arr[131074]), [in101]"v"((uint64_t *)&arr[786435]), [in103]"v"((uint64_t *)&arr[131075]), [in105]"v"((uint64_t *)&arr[65538]), [in107]"v"((uint64_t *)&arr[655364]), [in109]"v"((uint64_t *)&arr[458757]), [in111]"v"((uint64_t *)&arr[458758]), [in113]"v"((uint64_t *)&arr[720900]), [in115]"v"((uint64_t *)&arr[65539]), [in117]"v"((uint64_t *)&arr[655365]), [in119]"v"((uint64_t *)&arr[196610])
        : "memory");
}
