...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_10, c_16, c_17, c_18, c_19, c_20, c_12, c_10, c_1, c_21, c_22, c_2, c_19, c_23, c_12, c_24, c_13, c_4, c_11, c_25, c_1, c_26, c_27, c_8, c_2, c_28, c_8, c_29, c_30, c_31, c_13, c_32, c_28, c_29, c_33, c_19, c_34, c_20, c_35, c_36, c_37, c_38, c_16, c_39
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[1245184]), [in43]"v"((uint64_t *)&arr[1310720]), [in45]"v"((uint64_t *)&arr[786433]), [in47]"v"((uint64_t *)&arr[655362]), [in49]"v"((uint64_t *)&arr[65537]), [in51]"v"((uint64_t *)&arr[1376256]), [in53]"v"((uint64_t *)&arr[1441792]), [in55]"v"((uint64_t *)&arr[131073]), [in57]"v"((uint64_t *)&arr[1245185]), [in59]"v"((uint64_t *)&arr[1507328]), [in61]"v"((uint64_t *)&arr[786434]), [in63]"v"((uint64_t *)&arr[1572864]), [in65]"v"((uint64_t *)&arr[851969]), [in67]"v"((uint64_t *)&arr[262145]), [in69]"v"((uint64_t *)&arr[720897]), [in71]"v"((uint64_t *)&arr[1638400]), [in73]"v"((uint64_t *)&arr[65538]), [in75]"v"((uint64_t *)&arr[1703936]), [in77]"v"((uint64_t *)&arr[1769472]), [in79]"v"((uint64_t *)&arr[524289])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[131074]), [in83]"v"((uint64_t *)&arr[1835008]), [in85]"v"((uint64_t *)&arr[524290]), [in87]"v"((uint64_t *)&arr[1900544]), [in89]"v"((uint64_t *)&arr[1966080]), [in91]"v"((uint64_t *)&arr[2031616]), [in93]"v"((uint64_t *)&arr[851970]), [in95]"v"((uint64_t *)&arr[2097152]), [in97]"v"((uint64_t *)&arr[1835009]), [in99]"v"((uint64_t *)&arr[1900545]), [in101]"v"((uint64_t *)&arr[2162688]), [in103]"v"((uint64_t *)&arr[1245186]), [in105]"v"((uint64_t *)&arr[2228224]), [in107]"v"((uint64_t *)&arr[1310721]), [in109]"v"((uint64_t *)&arr[2293760]), [in111]"v"((uint64_t *)&arr[2359296]), [in113]"v"((uint64_t *)&arr[2424832]), [in115]"v"((uint64_t *)&arr[2490368]), [in117]"v"((uint64_t *)&arr[1048577]), [in119]"v"((uint64_t *)&arr[2555904])
        : "memory");
}
