...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_6, c_1, c_15, c_0, c_7, c_6, c_3, c_14, c_9, c_11, c_8, c_2, c_8, c_0, c_0, c_11, c_12, c_12, c_7, c_14, c_7, c_2, c_0, c_2, c_4, c_8, c_2, c_0, c_10, c_6, c_4, c_2, c_11, c_6, c_7, c_6, c_5, c_8, c_15, c_9, c_0, c_13, c_0, c_6
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[458753]), [in43]"v"((uint64_t *)&arr[393218]), [in45]"v"((uint64_t *)&arr[196609]), [in47]"v"((uint64_t *)&arr[917505]), [in49]"v"((uint64_t *)&arr[589825]), [in51]"v"((uint64_t *)&arr[720897]), [in53]"v"((uint64_t *)&arr[524289]), [in55]"v"((uint64_t *)&arr[131073]), [in57]"v"((uint64_t *)&arr[524290]), [in59]"v"((uint64_t *)&arr[2]), [in61]"v"((uint64_t *)&arr[3]), [in63]"v"((uint64_t *)&arr[720898]), [in65]"v"((uint64_t *)&arr[786433]), [in67]"v"((uint64_t *)&arr[786434]), [in69]"v"((uint64_t *)&arr[458754]), [in71]"v"((uint64_t *)&arr[917506]), [in73]"v"((uint64_t *)&arr[458755]), [in75]"v"((uint64_t *)&arr[131074]), [in77]"v"((uint64_t *)&arr[4]), [in79]"v"((uint64_t *)&arr[131075])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[262145]), [in83]"v"((uint64_t *)&arr[524291]), [in85]"v"((uint64_t *)&arr[131076]), [in87]"v"((uint64_t *)&arr[5]), [in89]"v"((uint64_t *)&arr[655361]), [in91]"v"((uint64_t *)&arr[393219]), [in93]"v"((uint64_t *)&arr[262146]), [in95]"v"((uint64_t *)&arr[131077]), [in97]"v"((uint64_t *)&arr[720899]), [in99]"v"((uint64_t *)&arr[393220]), [in101]"v"((uint64_t *)&arr[458756]), [in103]"v"((uint64_t *)&arr[393221]), [in105]"v"((uint64_t *)&arr[327681]), [in107]"v"((uint64_t *)&arr[524292]), [in109]"v"((uint64_t *)&arr[983042]), [in111]"v"((uint64_t *)&arr[589826]), [in113]"v"((uint64_t *)&arr[6]), [in115]"v"((uint64_t *)&arr[851969]), [in117]"v"((uint64_t *)&arr[7]), [in119]"v"((uint64_t *)&arr[393222])
        : "memory");
}
