...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_9, c_4, c_13, c_12, c_13, c_2, c_6, c_9, c_9, c_4, c_2, c_6, c_7, c_4, c_3, c_7, c_3, c_13, c_15, c_12, c_12, c_4, c_12, c_2, c_13, c_7, c_0, c_5, c_12, c_4, c_13, c_10, c_15, c_5, c_9, c_2, c_11, c_7, c_9, c_6, c_4, c_12, c_15, c_9
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[851970]), [in43]"v"((uint64_t *)&arr[131073]), [in45]"v"((uint64_t *)&arr[393217]), [in47]"v"((uint64_t *)&arr[589826]), [in49]"v"((uint64_t *)&arr[589827]), [in51]"v"((uint64_t *)&arr[262146]), [in53]"v"((uint64_t *)&arr[131074]), [in55]"v"((uint64_t *)&arr[393218]), [in57]"v"((uint64_t *)&arr[458753]), [in59]"v"((uint64_t *)&arr[262147]), [in61]"v"((uint64_t *)&arr[196609]), [in63]"v"((uint64_t *)&arr[458754]), [in65]"v"((uint64_t *)&arr[196610]), [in67]"v"((uint64_t *)&arr[851971]), [in69]"v"((uint64_t *)&arr[983041]), [in71]"v"((uint64_t *)&arr[786434]), [in73]"v"((uint64_t *)&arr[786435]), [in75]"v"((uint64_t *)&arr[262148]), [in77]"v"((uint64_t *)&arr[786436]), [in79]"v"((uint64_t *)&arr[131075])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[851972]), [in83]"v"((uint64_t *)&arr[458755]), [in85]"v"((uint64_t *)&arr[1]), [in87]"v"((uint64_t *)&arr[327681]), [in89]"v"((uint64_t *)&arr[786437]), [in91]"v"((uint64_t *)&arr[262149]), [in93]"v"((uint64_t *)&arr[851973]), [in95]"v"((uint64_t *)&arr[655361]), [in97]"v"((uint64_t *)&arr[983042]), [in99]"v"((uint64_t *)&arr[327682]), [in101]"v"((uint64_t *)&arr[589828]), [in103]"v"((uint64_t *)&arr[131076]), [in105]"v"((uint64_t *)&arr[720897]), [in107]"v"((uint64_t *)&arr[458756]), [in109]"v"((uint64_t *)&arr[589829]), [in111]"v"((uint64_t *)&arr[393219]), [in113]"v"((uint64_t *)&arr[262150]), [in115]"v"((uint64_t *)&arr[786438]), [in117]"v"((uint64_t *)&arr[983043]), [in119]"v"((uint64_t *)&arr[589830])
        : "memory");
}
