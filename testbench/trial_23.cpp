...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_4, c_11, c_1, c_11, c_5, c_1, c_12, c_5, c_2, c_0, c_4, c_0, c_5, c_11, c_4, c_4, c_3, c_0, c_10, c_12, c_5, c_10, c_11, c_4, c_13, c_13, c_11, c_1, c_7, c_2, c_1, c_9, c_6, c_1, c_6, c_5, c_2, c_6, c_6, c_13, c_0, c_4, c_8, c_8
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[327681]), [in43]"v"((uint64_t *)&arr[65538]), [in45]"v"((uint64_t *)&arr[786433]), [in47]"v"((uint64_t *)&arr[327682]), [in49]"v"((uint64_t *)&arr[131073]), [in51]"v"((uint64_t *)&arr[1]), [in53]"v"((uint64_t *)&arr[262146]), [in55]"v"((uint64_t *)&arr[2]), [in57]"v"((uint64_t *)&arr[327683]), [in59]"v"((uint64_t *)&arr[720899]), [in61]"v"((uint64_t *)&arr[262147]), [in63]"v"((uint64_t *)&arr[262148]), [in65]"v"((uint64_t *)&arr[196609]), [in67]"v"((uint64_t *)&arr[3]), [in69]"v"((uint64_t *)&arr[655361]), [in71]"v"((uint64_t *)&arr[786434]), [in73]"v"((uint64_t *)&arr[327684]), [in75]"v"((uint64_t *)&arr[655362]), [in77]"v"((uint64_t *)&arr[720900]), [in79]"v"((uint64_t *)&arr[262149])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[851969]), [in83]"v"((uint64_t *)&arr[851970]), [in85]"v"((uint64_t *)&arr[720901]), [in87]"v"((uint64_t *)&arr[65539]), [in89]"v"((uint64_t *)&arr[458753]), [in91]"v"((uint64_t *)&arr[131074]), [in93]"v"((uint64_t *)&arr[65540]), [in95]"v"((uint64_t *)&arr[589825]), [in97]"v"((uint64_t *)&arr[393217]), [in99]"v"((uint64_t *)&arr[65541]), [in101]"v"((uint64_t *)&arr[393218]), [in103]"v"((uint64_t *)&arr[327685]), [in105]"v"((uint64_t *)&arr[131075]), [in107]"v"((uint64_t *)&arr[393219]), [in109]"v"((uint64_t *)&arr[393220]), [in111]"v"((uint64_t *)&arr[851971]), [in113]"v"((uint64_t *)&arr[4]), [in115]"v"((uint64_t *)&arr[262150]), [in117]"v"((uint64_t *)&arr[524289]), [in119]"v"((uint64_t *)&arr[524290])
        : "memory");
}
