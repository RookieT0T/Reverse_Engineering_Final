...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_16, c_11, c_13, c_17, c_1, c_18, c_10, c_10, c_19, c_13, c_20, c_21, c_21, c_12, c_13, c_15, c_16, c_22, c_10, c_15, c_5, c_1, c_6, c_23, c_8, c_19, c_3, c_24, c_22, c_25, c_21, c_9, c_26, c_26, c_27, c_11, c_7, c_15, c_4, c_21, c_28, c_23, c_29, c_30
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[65537]), [in43]"v"((uint64_t *)&arr[1179648]), [in45]"v"((uint64_t *)&arr[655361]), [in47]"v"((uint64_t *)&arr[655362]), [in49]"v"((uint64_t *)&arr[1245184]), [in51]"v"((uint64_t *)&arr[851970]), [in53]"v"((uint64_t *)&arr[1310720]), [in55]"v"((uint64_t *)&arr[1376256]), [in57]"v"((uint64_t *)&arr[1376257]), [in59]"v"((uint64_t *)&arr[786433]), [in61]"v"((uint64_t *)&arr[851971]), [in63]"v"((uint64_t *)&arr[983041]), [in65]"v"((uint64_t *)&arr[1048577]), [in67]"v"((uint64_t *)&arr[1441792]), [in69]"v"((uint64_t *)&arr[655363]), [in71]"v"((uint64_t *)&arr[983042]), [in73]"v"((uint64_t *)&arr[327681]), [in75]"v"((uint64_t *)&arr[65538]), [in77]"v"((uint64_t *)&arr[393217]), [in79]"v"((uint64_t *)&arr[1507328])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[524289]), [in83]"v"((uint64_t *)&arr[1245185]), [in85]"v"((uint64_t *)&arr[196609]), [in87]"v"((uint64_t *)&arr[1572864]), [in89]"v"((uint64_t *)&arr[1441793]), [in91]"v"((uint64_t *)&arr[1638400]), [in93]"v"((uint64_t *)&arr[1376258]), [in95]"v"((uint64_t *)&arr[589825]), [in97]"v"((uint64_t *)&arr[1703936]), [in99]"v"((uint64_t *)&arr[1703937]), [in101]"v"((uint64_t *)&arr[1769472]), [in103]"v"((uint64_t *)&arr[720898]), [in105]"v"((uint64_t *)&arr[458753]), [in107]"v"((uint64_t *)&arr[983043]), [in109]"v"((uint64_t *)&arr[262145]), [in111]"v"((uint64_t *)&arr[1376259]), [in113]"v"((uint64_t *)&arr[1835008]), [in115]"v"((uint64_t *)&arr[1507329]), [in117]"v"((uint64_t *)&arr[1900544]), [in119]"v"((uint64_t *)&arr[1966080])
        : "memory");
}
