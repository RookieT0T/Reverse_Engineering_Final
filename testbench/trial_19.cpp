...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_2, c_15, c_1, c_12, c_1, c_3, c_8, c_0, c_5, c_4, c_8, c_2, c_14, c_11, c_2, c_13, c_15, c_2, c_0, c_4, c_12, c_10, c_6, c_6, c_4, c_0, c_15, c_7, c_3, c_9, c_15, c_5, c_15, c_11, c_15, c_4, c_13, c_5, c_14, c_10, c_2, c_3, c_12, c_13
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[65538]), [in43]"v"((uint64_t *)&arr[196609]), [in45]"v"((uint64_t *)&arr[524289]), [in47]"v"((uint64_t *)&arr[1]), [in49]"v"((uint64_t *)&arr[327681]), [in51]"v"((uint64_t *)&arr[262145]), [in53]"v"((uint64_t *)&arr[524290]), [in55]"v"((uint64_t *)&arr[131074]), [in57]"v"((uint64_t *)&arr[917505]), [in59]"v"((uint64_t *)&arr[720897]), [in61]"v"((uint64_t *)&arr[131075]), [in63]"v"((uint64_t *)&arr[851969]), [in65]"v"((uint64_t *)&arr[983042]), [in67]"v"((uint64_t *)&arr[131076]), [in69]"v"((uint64_t *)&arr[2]), [in71]"v"((uint64_t *)&arr[262146]), [in73]"v"((uint64_t *)&arr[786434]), [in75]"v"((uint64_t *)&arr[655361]), [in77]"v"((uint64_t *)&arr[393217]), [in79]"v"((uint64_t *)&arr[393218])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[262147]), [in83]"v"((uint64_t *)&arr[3]), [in85]"v"((uint64_t *)&arr[983043]), [in87]"v"((uint64_t *)&arr[458753]), [in89]"v"((uint64_t *)&arr[196610]), [in91]"v"((uint64_t *)&arr[589825]), [in93]"v"((uint64_t *)&arr[983044]), [in95]"v"((uint64_t *)&arr[327682]), [in97]"v"((uint64_t *)&arr[983045]), [in99]"v"((uint64_t *)&arr[720898]), [in101]"v"((uint64_t *)&arr[983046]), [in103]"v"((uint64_t *)&arr[262148]), [in105]"v"((uint64_t *)&arr[851970]), [in107]"v"((uint64_t *)&arr[327683]), [in109]"v"((uint64_t *)&arr[917506]), [in111]"v"((uint64_t *)&arr[655362]), [in113]"v"((uint64_t *)&arr[131077]), [in115]"v"((uint64_t *)&arr[196611]), [in117]"v"((uint64_t *)&arr[786435]), [in119]"v"((uint64_t *)&arr[851971])
        : "memory");
}
