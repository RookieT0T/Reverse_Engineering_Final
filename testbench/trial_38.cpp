...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_15, c_8, c_1, c_15, c_13, c_13, c_15, c_11, c_1, c_0, c_12, c_9, c_2, c_7, c_15, c_8, c_1, c_5, c_9, c_0, c_10, c_7, c_1, c_15, c_2, c_8, c_3, c_15, c_9, c_15, c_5, c_15, c_7, c_15, c_13, c_0, c_8, c_10, c_11, c_15, c_8, c_8, c_15, c_12
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[851969]), [in43]"v"((uint64_t *)&arr[851970]), [in45]"v"((uint64_t *)&arr[983043]), [in47]"v"((uint64_t *)&arr[720897]), [in49]"v"((uint64_t *)&arr[65538]), [in51]"v"((uint64_t *)&arr[1]), [in53]"v"((uint64_t *)&arr[786433]), [in55]"v"((uint64_t *)&arr[589825]), [in57]"v"((uint64_t *)&arr[131073]), [in59]"v"((uint64_t *)&arr[458753]), [in61]"v"((uint64_t *)&arr[983044]), [in63]"v"((uint64_t *)&arr[524290]), [in65]"v"((uint64_t *)&arr[65539]), [in67]"v"((uint64_t *)&arr[327681]), [in69]"v"((uint64_t *)&arr[589826]), [in71]"v"((uint64_t *)&arr[2]), [in73]"v"((uint64_t *)&arr[655361]), [in75]"v"((uint64_t *)&arr[458754]), [in77]"v"((uint64_t *)&arr[65540]), [in79]"v"((uint64_t *)&arr[983045])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[131074]), [in83]"v"((uint64_t *)&arr[524291]), [in85]"v"((uint64_t *)&arr[196609]), [in87]"v"((uint64_t *)&arr[983046]), [in89]"v"((uint64_t *)&arr[589827]), [in91]"v"((uint64_t *)&arr[983047]), [in93]"v"((uint64_t *)&arr[327682]), [in95]"v"((uint64_t *)&arr[983048]), [in97]"v"((uint64_t *)&arr[458755]), [in99]"v"((uint64_t *)&arr[983049]), [in101]"v"((uint64_t *)&arr[851971]), [in103]"v"((uint64_t *)&arr[3]), [in105]"v"((uint64_t *)&arr[524292]), [in107]"v"((uint64_t *)&arr[655362]), [in109]"v"((uint64_t *)&arr[720898]), [in111]"v"((uint64_t *)&arr[983050]), [in113]"v"((uint64_t *)&arr[524293]), [in115]"v"((uint64_t *)&arr[524294]), [in117]"v"((uint64_t *)&arr[983051]), [in119]"v"((uint64_t *)&arr[786434])
        : "memory");
}
