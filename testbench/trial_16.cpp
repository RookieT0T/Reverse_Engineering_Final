...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_0, c_6, c_1, c_0, c_6, c_9, c_5, c_10, c_13, c_6, c_4, c_3, c_14, c_8, c_12, c_15, c_4, c_15, c_11, c_11, c_14, c_11, c_4, c_3, c_0, c_10, c_4, c_12, c_15, c_5, c_15, c_11, c_9, c_9, c_10, c_4, c_11, c_8, c_7, c_14, c_6, c_6, c_3, c_13
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[393218]), [in43]"v"((uint64_t *)&arr[589825]), [in45]"v"((uint64_t *)&arr[327681]), [in47]"v"((uint64_t *)&arr[655361]), [in49]"v"((uint64_t *)&arr[851969]), [in51]"v"((uint64_t *)&arr[393219]), [in53]"v"((uint64_t *)&arr[262145]), [in55]"v"((uint64_t *)&arr[196609]), [in57]"v"((uint64_t *)&arr[917505]), [in59]"v"((uint64_t *)&arr[524289]), [in61]"v"((uint64_t *)&arr[786433]), [in63]"v"((uint64_t *)&arr[983041]), [in65]"v"((uint64_t *)&arr[262146]), [in67]"v"((uint64_t *)&arr[983042]), [in69]"v"((uint64_t *)&arr[720897]), [in71]"v"((uint64_t *)&arr[720898]), [in73]"v"((uint64_t *)&arr[917506]), [in75]"v"((uint64_t *)&arr[720899]), [in77]"v"((uint64_t *)&arr[262147]), [in79]"v"((uint64_t *)&arr[196610])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[3]), [in83]"v"((uint64_t *)&arr[655362]), [in85]"v"((uint64_t *)&arr[262148]), [in87]"v"((uint64_t *)&arr[786434]), [in89]"v"((uint64_t *)&arr[983043]), [in91]"v"((uint64_t *)&arr[327682]), [in93]"v"((uint64_t *)&arr[983044]), [in95]"v"((uint64_t *)&arr[720900]), [in97]"v"((uint64_t *)&arr[589826]), [in99]"v"((uint64_t *)&arr[589827]), [in101]"v"((uint64_t *)&arr[655363]), [in103]"v"((uint64_t *)&arr[262149]), [in105]"v"((uint64_t *)&arr[720901]), [in107]"v"((uint64_t *)&arr[524290]), [in109]"v"((uint64_t *)&arr[458753]), [in111]"v"((uint64_t *)&arr[917507]), [in113]"v"((uint64_t *)&arr[393220]), [in115]"v"((uint64_t *)&arr[393221]), [in117]"v"((uint64_t *)&arr[196611]), [in119]"v"((uint64_t *)&arr[851970])
        : "memory");
}
