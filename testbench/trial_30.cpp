...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_9, c_3, c_3, c_6, c_8, c_14, c_15, c_1, c_1, c_3, c_4, c_6, c_3, c_3, c_8, c_2, c_3, c_2, c_8, c_1, c_9, c_10, c_4, c_1, c_6, c_12, c_7, c_14, c_7, c_15, c_7, c_2, c_0, c_0, c_3, c_1, c_4, c_3, c_6, c_0, c_9, c_5, c_0, c_4
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[524289]), [in43]"v"((uint64_t *)&arr[917505]), [in45]"v"((uint64_t *)&arr[983041]), [in47]"v"((uint64_t *)&arr[65537]), [in49]"v"((uint64_t *)&arr[65538]), [in51]"v"((uint64_t *)&arr[196611]), [in53]"v"((uint64_t *)&arr[262145]), [in55]"v"((uint64_t *)&arr[393218]), [in57]"v"((uint64_t *)&arr[196612]), [in59]"v"((uint64_t *)&arr[196613]), [in61]"v"((uint64_t *)&arr[524290]), [in63]"v"((uint64_t *)&arr[131073]), [in65]"v"((uint64_t *)&arr[196614]), [in67]"v"((uint64_t *)&arr[131074]), [in69]"v"((uint64_t *)&arr[524291]), [in71]"v"((uint64_t *)&arr[65539]), [in73]"v"((uint64_t *)&arr[589826]), [in75]"v"((uint64_t *)&arr[655361]), [in77]"v"((uint64_t *)&arr[262146]), [in79]"v"((uint64_t *)&arr[65540])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[393219]), [in83]"v"((uint64_t *)&arr[786433]), [in85]"v"((uint64_t *)&arr[458753]), [in87]"v"((uint64_t *)&arr[917506]), [in89]"v"((uint64_t *)&arr[458754]), [in91]"v"((uint64_t *)&arr[983042]), [in93]"v"((uint64_t *)&arr[458755]), [in95]"v"((uint64_t *)&arr[131075]), [in97]"v"((uint64_t *)&arr[1]), [in99]"v"((uint64_t *)&arr[2]), [in101]"v"((uint64_t *)&arr[196615]), [in103]"v"((uint64_t *)&arr[65541]), [in105]"v"((uint64_t *)&arr[262147]), [in107]"v"((uint64_t *)&arr[196616]), [in109]"v"((uint64_t *)&arr[393220]), [in111]"v"((uint64_t *)&arr[3]), [in113]"v"((uint64_t *)&arr[589827]), [in115]"v"((uint64_t *)&arr[327681]), [in117]"v"((uint64_t *)&arr[4]), [in119]"v"((uint64_t *)&arr[262148])
        : "memory");
}
