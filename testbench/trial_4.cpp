...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_13, c_7, c_5, c_5, c_3, c_13, c_8, c_10, c_14, c_0, c_1, c_5, c_6, c_14, c_6, c_7, c_4, c_4, c_13, c_15, c_2, c_8, c_7, c_5, c_9, c_2, c_8, c_3, c_9, c_9, c_12, c_2, c_9, c_1, c_9, c_15, c_0, c_5, c_0, c_7, c_14, c_3, c_6, c_8
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[196609]), [in43]"v"((uint64_t *)&arr[851970]), [in45]"v"((uint64_t *)&arr[524289]), [in47]"v"((uint64_t *)&arr[655361]), [in49]"v"((uint64_t *)&arr[917505]), [in51]"v"((uint64_t *)&arr[1]), [in53]"v"((uint64_t *)&arr[65537]), [in55]"v"((uint64_t *)&arr[327683]), [in57]"v"((uint64_t *)&arr[393217]), [in59]"v"((uint64_t *)&arr[917506]), [in61]"v"((uint64_t *)&arr[393218]), [in63]"v"((uint64_t *)&arr[458754]), [in65]"v"((uint64_t *)&arr[262145]), [in67]"v"((uint64_t *)&arr[262146]), [in69]"v"((uint64_t *)&arr[851971]), [in71]"v"((uint64_t *)&arr[983041]), [in73]"v"((uint64_t *)&arr[131073]), [in75]"v"((uint64_t *)&arr[524290]), [in77]"v"((uint64_t *)&arr[458755]), [in79]"v"((uint64_t *)&arr[327684])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[589825]), [in83]"v"((uint64_t *)&arr[131074]), [in85]"v"((uint64_t *)&arr[524291]), [in87]"v"((uint64_t *)&arr[196610]), [in89]"v"((uint64_t *)&arr[589826]), [in91]"v"((uint64_t *)&arr[589827]), [in93]"v"((uint64_t *)&arr[786433]), [in95]"v"((uint64_t *)&arr[131075]), [in97]"v"((uint64_t *)&arr[589828]), [in99]"v"((uint64_t *)&arr[65538]), [in101]"v"((uint64_t *)&arr[589829]), [in103]"v"((uint64_t *)&arr[983042]), [in105]"v"((uint64_t *)&arr[2]), [in107]"v"((uint64_t *)&arr[327685]), [in109]"v"((uint64_t *)&arr[3]), [in111]"v"((uint64_t *)&arr[458756]), [in113]"v"((uint64_t *)&arr[917507]), [in115]"v"((uint64_t *)&arr[196611]), [in117]"v"((uint64_t *)&arr[393219]), [in119]"v"((uint64_t *)&arr[524292])
        : "memory");
}
