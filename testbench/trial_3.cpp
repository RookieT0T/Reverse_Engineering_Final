...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_11, c_6, c_15, c_5, c_5, c_9, c_1, c_9, c_5, c_3, c_2, c_10, c_3, c_2, c_13, c_2, c_3, c_1, c_14, c_4, c_15, c_13, c_14, c_7, c_15, c_1, c_14, c_11, c_0, c_6, c_8, c_1, c_11, c_9, c_3, c_10, c_4, c_5, c_5, c_10, c_3, c_13, c_1, c_3
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[327682]), [in43]"v"((uint64_t *)&arr[589825]), [in45]"v"((uint64_t *)&arr[65537]), [in47]"v"((uint64_t *)&arr[589826]), [in49]"v"((uint64_t *)&arr[327683]), [in51]"v"((uint64_t *)&arr[196609]), [in53]"v"((uint64_t *)&arr[131073]), [in55]"v"((uint64_t *)&arr[655361]), [in57]"v"((uint64_t *)&arr[196610]), [in59]"v"((uint64_t *)&arr[131074]), [in61]"v"((uint64_t *)&arr[851969]), [in63]"v"((uint64_t *)&arr[131075]), [in65]"v"((uint64_t *)&arr[196611]), [in67]"v"((uint64_t *)&arr[65538]), [in69]"v"((uint64_t *)&arr[917505]), [in71]"v"((uint64_t *)&arr[262145]), [in73]"v"((uint64_t *)&arr[983042]), [in75]"v"((uint64_t *)&arr[851970]), [in77]"v"((uint64_t *)&arr[917506]), [in79]"v"((uint64_t *)&arr[458753])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[983043]), [in83]"v"((uint64_t *)&arr[65539]), [in85]"v"((uint64_t *)&arr[917507]), [in87]"v"((uint64_t *)&arr[720898]), [in89]"v"((uint64_t *)&arr[1]), [in91]"v"((uint64_t *)&arr[393218]), [in93]"v"((uint64_t *)&arr[524289]), [in95]"v"((uint64_t *)&arr[65540]), [in97]"v"((uint64_t *)&arr[720899]), [in99]"v"((uint64_t *)&arr[589827]), [in101]"v"((uint64_t *)&arr[196612]), [in103]"v"((uint64_t *)&arr[655362]), [in105]"v"((uint64_t *)&arr[262146]), [in107]"v"((uint64_t *)&arr[327684]), [in109]"v"((uint64_t *)&arr[327685]), [in111]"v"((uint64_t *)&arr[655363]), [in113]"v"((uint64_t *)&arr[196613]), [in115]"v"((uint64_t *)&arr[851971]), [in117]"v"((uint64_t *)&arr[65541]), [in119]"v"((uint64_t *)&arr[196614])
        : "memory");
}
