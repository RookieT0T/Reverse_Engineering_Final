...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_14, c_0, c_8, c_13, c_11, c_9, c_6, c_13, c_10, c_6, c_10, c_9, c_10, c_4, c_15, c_3, c_15, c_0, c_14, c_15, c_8, c_1, c_1, c_5, c_1, c_10, c_9, c_11, c_5, c_12, c_15, c_10, c_10, c_0, c_3, c_8, c_14, c_1, c_5, c_1, c_1, c_11, c_9, c_15
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[720897]), [in43]"v"((uint64_t *)&arr[589825]), [in45]"v"((uint64_t *)&arr[393217]), [in47]"v"((uint64_t *)&arr[851970]), [in49]"v"((uint64_t *)&arr[655361]), [in51]"v"((uint64_t *)&arr[393218]), [in53]"v"((uint64_t *)&arr[655362]), [in55]"v"((uint64_t *)&arr[589826]), [in57]"v"((uint64_t *)&arr[655363]), [in59]"v"((uint64_t *)&arr[262145]), [in61]"v"((uint64_t *)&arr[983041]), [in63]"v"((uint64_t *)&arr[196609]), [in65]"v"((uint64_t *)&arr[983042]), [in67]"v"((uint64_t *)&arr[2]), [in69]"v"((uint64_t *)&arr[917506]), [in71]"v"((uint64_t *)&arr[983043]), [in73]"v"((uint64_t *)&arr[524290]), [in75]"v"((uint64_t *)&arr[65537]), [in77]"v"((uint64_t *)&arr[65538]), [in79]"v"((uint64_t *)&arr[327681])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[65539]), [in83]"v"((uint64_t *)&arr[655364]), [in85]"v"((uint64_t *)&arr[589827]), [in87]"v"((uint64_t *)&arr[720898]), [in89]"v"((uint64_t *)&arr[327682]), [in91]"v"((uint64_t *)&arr[786433]), [in93]"v"((uint64_t *)&arr[983044]), [in95]"v"((uint64_t *)&arr[655365]), [in97]"v"((uint64_t *)&arr[655366]), [in99]"v"((uint64_t *)&arr[3]), [in101]"v"((uint64_t *)&arr[196610]), [in103]"v"((uint64_t *)&arr[524291]), [in105]"v"((uint64_t *)&arr[917507]), [in107]"v"((uint64_t *)&arr[65540]), [in109]"v"((uint64_t *)&arr[327683]), [in111]"v"((uint64_t *)&arr[65541]), [in113]"v"((uint64_t *)&arr[65542]), [in115]"v"((uint64_t *)&arr[720899]), [in117]"v"((uint64_t *)&arr[589828]), [in119]"v"((uint64_t *)&arr[983045])
        : "memory");
}
