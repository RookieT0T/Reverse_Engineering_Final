...
// kernel code
// Access pattern: c_0, c_1, c_2, c_3, c_4, c_5, c_6, c_7, c_8, c_9, c_10, c_11, c_12, c_13, c_14, c_15, c_12, c_5, c_6, c_15, c_9, c_10, c_15, c_12, c_15, c_1, c_3, c_12, c_12, c_14, c_10, c_0, c_5, c_11, c_6, c_10, c_4, c_0, c_13, c_13, c_12, c_12, c_3, c_1, c_7, c_0, c_11, c_0, c_6, c_5, c_3, c_4, c_2, c_12, c_3, c_8, c_13, c_2, c_0, c_13
// Access count: 60
...
__global__ void kernel(int * arr) {
    ...
    asm volatile(
        ...
        : [in41]"v"((uint64_t *)&arr[589825]), [in43]"v"((uint64_t *)&arr[655361]), [in45]"v"((uint64_t *)&arr[983042]), [in47]"v"((uint64_t *)&arr[786434]), [in49]"v"((uint64_t *)&arr[983043]), [in51]"v"((uint64_t *)&arr[65537]), [in53]"v"((uint64_t *)&arr[196609]), [in55]"v"((uint64_t *)&arr[786435]), [in57]"v"((uint64_t *)&arr[786436]), [in59]"v"((uint64_t *)&arr[917505]), [in61]"v"((uint64_t *)&arr[655362]), [in63]"v"((uint64_t *)&arr[1]), [in65]"v"((uint64_t *)&arr[327682]), [in67]"v"((uint64_t *)&arr[720897]), [in69]"v"((uint64_t *)&arr[393218]), [in71]"v"((uint64_t *)&arr[655363]), [in73]"v"((uint64_t *)&arr[262145]), [in75]"v"((uint64_t *)&arr[2]), [in77]"v"((uint64_t *)&arr[851969]), [in79]"v"((uint64_t *)&arr[851970])
        : "memory");
    ...
    asm volatile(
        ...
        : [in81]"v"((uint64_t *)&arr[786437]), [in83]"v"((uint64_t *)&arr[786438]), [in85]"v"((uint64_t *)&arr[196610]), [in87]"v"((uint64_t *)&arr[65538]), [in89]"v"((uint64_t *)&arr[458753]), [in91]"v"((uint64_t *)&arr[3]), [in93]"v"((uint64_t *)&arr[720898]), [in95]"v"((uint64_t *)&arr[4]), [in97]"v"((uint64_t *)&arr[393219]), [in99]"v"((uint64_t *)&arr[327683]), [in101]"v"((uint64_t *)&arr[196611]), [in103]"v"((uint64_t *)&arr[262146]), [in105]"v"((uint64_t *)&arr[131073]), [in107]"v"((uint64_t *)&arr[786439]), [in109]"v"((uint64_t *)&arr[196612]), [in111]"v"((uint64_t *)&arr[524289]), [in113]"v"((uint64_t *)&arr[851971]), [in115]"v"((uint64_t *)&arr[131074]), [in117]"v"((uint64_t *)&arr[5]), [in119]"v"((uint64_t *)&arr[851972])
        : "memory");
}
